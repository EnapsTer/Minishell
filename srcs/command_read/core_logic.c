...
/*   Updated: 2021/03/12 21:56:35 by nscarab          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	handle_new_line(int *continue_flag,
		char buf[131072], int count, t_env **env)
{
	buf[count - 1] = '\0';
...
static void	continue_read_after_eof(int *continue_flag,
		char buf[131072], t_env **env)
{
...
static void	handle_input(int count, char buf[131072],
		int *continue_flag, t_env **env)
{
	int		strlen;
